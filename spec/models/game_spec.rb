...
describe Game do
  ...
  describe "completion" do
    ...
    it "should save the change in rating for the challenged player" do
      subject.challenger_rating_change.to_f.should eq subject.send(:challenger_rating).send(:change).to_f
    end

    it "should save the change in rating for the challenger player" do
      subject.challenged_rating_change.to_f.should eq subject.send(:challenged_rating).send(:change).to_f
    end
  end
end
